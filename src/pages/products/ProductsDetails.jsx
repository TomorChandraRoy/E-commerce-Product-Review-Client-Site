...
const ProductsDetails = () => {
    ...
    const { image, description, price, rating, category, name, _id } = data;

   

    return (
        <div>
            <section className="text-gray-600 body-font overflow-hidden lg:mt-5">
                <div className="container px-5 py-24 mx-auto  rounded">
